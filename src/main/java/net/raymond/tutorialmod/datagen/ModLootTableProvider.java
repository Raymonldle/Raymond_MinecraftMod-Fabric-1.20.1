...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.RUBY_SLAB, doorDrops(ModBlocks.RUBY_SLAB));
        ...
        addDrop(ModBlocks.NETHERACK_RUBY_ORE, copperLikeOreDrops(ModBlocks.NETHERACK_RUBY_ORE, ModItems.RAW_RUBY));
        ...
        addDrop(ModBlocks.NETHERACK_SAPPHIRE_ORE, copperLikeOreDrops(ModBlocks.NETHERACK_SAPPHIRE_ORE, ModItems.RAW_SAPPHIRE));
