...
public class ModBlocks {
    ...
    public static final Block NETHERACK_RUBY_ORE = registerBlock("netherack_ruby_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.NETHERRACK ).strength(2.5f), UniformIntProvider.create(2, 5)));
    ...
    public static final Block DEEPSLATE_SAPPHIRE_ORE = registerBlock("deepslate_sapphire_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.DEEPSLATE).strength(4f), UniformIntProvider.create(2, 5)));
    public static final Block NETHERACK_SAPPHIRE_ORE = registerBlock("netherack_sapphire_ore",
            new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.NETHERRACK ).strength(2.5f), UniformIntProvider.create(2, 5)));
